...
<html lang="en">
  <head>
    ...
    <link href="/admin_assets/lib/rickshaw/rickshaw.min.css" rel="stylesheet">
    <link href="/admin_assets/lib/chartist/chartist.css" rel="stylesheet">
    <!-- toastr js -->
  ...
  <body>
    ...
    <div class="br-sideleft overflow-y-auto">
      ...
      <div class="br-sideleft-menu">
        <a href="/admin/dashboard" class="br-menu-link dashboard">
          <div class="br-menu-item">
            <i class="menu-item-icon icon ion-ios-home-outline tx-22"></i>
            <span class="menu-item-label">Dashboard</span>
          </div><!-- menu-item -->
        </a><!-- br-menu-link -->
        <a href="/admin/user" class="br-menu-link admin">
          <div class="br-menu-item">
        ...
        <a href="#" class="br-menu-link product">
          <div class="br-menu-item">
    ...
    <script src="/admin_assets/lib/chartist/chartist.js"></script>
    <script src="/admin_assets/lib/jquery.sparkline.bower/jquery.sparkline.min.js"></script>
    <script src="/admin_assets/lib/d3/d3.js"></script>
    <script src="/admin_assets/lib/rickshaw/rickshaw.min.js"></script>
    {{-- Toastr js --}}
