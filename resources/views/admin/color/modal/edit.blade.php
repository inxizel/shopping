...
<div class="modal-dialog modal-lg" role="document" style="width:500px;">
  <div class="modal-content tx-size-sm">
    <div class="modal-header pd-x-20">
      <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Edit Color</h6>
    ...
    <div class="form-group">
      ...
      <input type="text" name="value-edit" id="value-edit" class="form-control pd-y-12" placeholder="Size Value">
    </div> 
    </div><!-- modal-body -->
