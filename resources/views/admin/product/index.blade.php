      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <a href="/admin/product-image" class="btn btn-outline-success btn-icon mg-r-5 btn-delete" data-id="{{$row->id}}">
              <div><i class="fa fa-file-image-o"></i></div>
            </a>
            <a href="/admin/product-image" class="btn btn-outline-warning btn-icon mg-r-5 btn-delete" data-id="{{$row->id}}">
