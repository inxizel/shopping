					...
					<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
						<ol class="carousel-indicators">
							<li data-target="#carouselExampleIndicators" data-slide-to="0" class="active">
								<img src="/blog_assets/img/product/single-product/s-product-s-2.jpg" alt="">
							</li>
						...
						<div class="carousel-inner">
							...
							<div class="carousel-item active">
								<img class="d-block w-100" src="/storage/{{$image->product_image}}" alt="First slide">
							</div>
							@else
							<div class="carousel-item">
								<img class="d-block w-100" src="/storage/{{$image->product_image}}" alt="Second slide">
							</div>
							@endif
							@endforeach
			...
			<div class="col-lg-5 offset-lg-1">
				<div class="s_product_text">
					...
					<ul class="list">
						...
						<li>
							<a href="#">
								<span>Brand</span> : {{$product->brand_name}}</a>
						</li>
					</ul>
					...
					<div class="col-lg-6">
						<div class="comment_list">
							<div class="review_item">
								<div class="media">
									<div class="d-flex">
										<img src="/blog_assets/img/product/single-product/review-1.png" alt="">
									</div>
							...
							<div class="review_item reply">
								<div class="media">
									<div class="d-flex">
										<img src="/blog_assets/img/product/single-product/review-2.png" alt="">
									</div>
									<div class="media-body">
										<h4>Blake Ruiz</h4>
										<h5>12th Feb, 2017 at 05:56 pm</h5>
							...
							<div class="review_item">
								<div class="media">
									<div class="d-flex">
										<img src="/blog_assets/img/product/single-product/review-3.png" alt="">
									</div>
									<div class="media-body">
										<h4>Blake Ruiz</h4>
										<h5>12th Feb, 2017 at 05:56 pm</h5>
